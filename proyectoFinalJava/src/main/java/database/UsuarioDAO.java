...
public class UsuarioDAO {
    ...
    public UsuarioDAO() {
        ...
        String DB = "comprar_ticket";
        String userDB = "root";
        String passDB = "root";
        //connection = conn.getConnection("comprar_ticket", "root", "1234");
    ...
    public Usuario getUserByUsername(String username) throws SQLException {
        ...
        rs = ps.executeQuery();
        // si el IF es True, caraga las variables con los valores que trajo la query
        // se el IF es False devuelve un usuario nulo
        if (rs.next()) {
            String password = rs.getString("password");
            String name = rs.getString("name");
            String last_name = rs.getString("last_name");
            String email = rs.getString("email");
            // crea el usuario y pasa los datos antes cargado de las variables
