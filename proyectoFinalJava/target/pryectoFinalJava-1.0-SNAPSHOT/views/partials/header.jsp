...
<head>
    ...
    <link rel="stylesheet" href="/pryectoFinalJava/css/style.css">
    <!-- CSS only -->
    ...
    <header>
        ...
        <div class="flex-container">
            ...
            <nav class="a-la-derecha">
                ...
                <a id="buy-green" href="/pryectoFinalJava/views/login.jsp" style="display: <%= isLogin?"none":"initial" %>">Comprar tickets</a>
